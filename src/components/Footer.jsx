    ...
    <footer className="bg-slate-900 text-slate-400 text-sm border-t border-slate-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Brand Info */}
          <div>
            <a href="/" className="text-2xl font-black text-white tracking-tight inline-block mb-4">
              Buy<span className="text-indigo-500">Verse</span>
            </a>
            <p className="text-slate-400 mb-4 leading-relaxed">
              Your one-stop destination for modern tech, electronics, and daily essentials. Quality guaranteed.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>support@buyverse.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} BuyVerse. All rights reserved.</p>
